---
description: Update project docs after completing a feature or significant change
---

Use the @docs-librarian agent to update the project documentation after my recent changes.
...
4. Update `docs/INDEX.md` if new doc files were added
5. Report what was updated and flag any remaining gaps
